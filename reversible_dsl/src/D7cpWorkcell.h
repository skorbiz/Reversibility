...
#ifndef D7PC_ROS_REVERSIBLE_DSL_SRC_D7CPWORKCELL_H_
#define D7PC_ROS_REVERSIBLE_DSL_SRC_D7CPWORKCELL_H_
...
//	rw::math::Transform3D<> q2baseTtool(rw::math::Q q, const rw::kinematics::State state_input) const;
...
#endif /* D7PC_ROS_REVERSIBLE_DSL_SRC_D7CPWORKCELL_H_ */
