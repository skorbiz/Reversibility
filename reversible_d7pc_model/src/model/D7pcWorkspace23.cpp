...
D7pcWorkspace23::D7pcWorkspace23()
{
}
...
void D7pcWorkspace23::init()
{
	initEsentials();
	initVariables();
}

void D7pcWorkspace23::initEsentials()
{
...
void D7pcWorkspace23::initVariables()
{
...
//	plannerRedundency    = std::make_shared<Planner>(plannerTntRedundency, plannerTfi, wc, device);
//
//
...
rw::kinematics::State D7pcWorkspace23::getDefaultState()
{
	rw::kinematics::State s;
	return s;
//	return wc->getDefaultState();
}

void D7pcWorkspace23::setQ(const rw::math::Q& q, rw::kinematics::State& state) const
{
//	device->setQ(q, state);
}

void D7pcWorkspace23::attachTo(std::shared_ptr<rw::kinematics::Frame> child, std::shared_ptr<rw::kinematics::Frame> parent, rw::kinematics::State& state) const
{
...
//std::shared_ptr<rw::kinematics::Frame> D7pcWorkspace23::findFrame(std::string frameName) const
//{
//	assert(!wc.isNull() && "Could not find workcell!");
...
//}
//
//rw::math::Q D7pcWorkspace23::findQ(std::string qName) const
//{
