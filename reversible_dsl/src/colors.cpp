...
const std::string COLORRESET	= "\033[0m";			/* Reset color */
const std::string DEFAULT		= "\033[0m";			/* Reset color */
...
{
	return RED + input + COLORRESET;
}




//extern const std::string CLEAR = "\033[2J"  // clear screen escape code
